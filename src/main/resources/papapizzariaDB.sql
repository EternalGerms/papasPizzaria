...
-- Started on 2025-02-26 00:16:44
...
--
-- TOC entry 231 (class 1259 OID 18515)
...
--
-- TOC entry 232 (class 1259 OID 18520)
...
--
-- TOC entry 234 (class 1259 OID 18524)
...
--
-- TOC entry 4793 (class 2604 OID 18531)
...
--
-- TOC entry 4794 (class 2604 OID 18532)
...
--
-- TOC entry 4972 (class 0 OID 18475)
-- Dependencies: 217
...
--
-- TOC entry 4973 (class 0 OID 18480)
-- Dependencies: 218
...
--
-- TOC entry 4975 (class 0 OID 18486)
-- Dependencies: 220
...
--
-- TOC entry 4977 (class 0 OID 18490)
-- Dependencies: 222
...
--
-- TOC entry 4979 (class 0 OID 18496)
-- Dependencies: 224
...
--
-- TOC entry 4980 (class 0 OID 18499)
-- Dependencies: 225
...
--
-- TOC entry 4982 (class 0 OID 18503)
-- Dependencies: 227
...
--
-- TOC entry 4984 (class 0 OID 18511)
-- Dependencies: 229
...
--
-- TOC entry 4986 (class 0 OID 18515)
-- Dependencies: 231
-- Data for Name: usuario; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.usuario (id, "nomeCompleto", cpfcnpj, email, telefone, tipo, ativado, login, senha) FROM stdin;
\.
...
--
-- TOC entry 4809 (class 2606 OID 18546)
...
--
-- TOC entry 4813 (class 2606 OID 18548)
...
--
-- TOC entry 4810 (class 1259 OID 18550)
...
--
-- TOC entry 4811 (class 1259 OID 18551)
-- Name: fki_fk_id_vendedor; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- TOC entry 4818 (class 2606 OID 18552)
...
--
-- TOC entry 4821 (class 2606 OID 18557)
...
--
-- TOC entry 4814 (class 2606 OID 18562)
-- Name: caixa fk_id_Vendedor; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.caixa
    ADD CONSTRAINT "fk_id_Vendedor" FOREIGN KEY (operador) REFERENCES public.usuario(id) NOT VALID;


--
-- TOC entry 4822 (class 2606 OID 18567)
-- Name: vendas fk_id_cliente; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.vendas
    ADD CONSTRAINT fk_id_cliente FOREIGN KEY (id_cliente) REFERENCES public.usuario(id);


--
-- TOC entry 4816 (class 2606 OID 18572)
-- Name: enderecosadd fk_id_cliente; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.enderecosadd
    ADD CONSTRAINT fk_id_cliente FOREIGN KEY (idcliente) REFERENCES public.usuario(id);


--
-- TOC entry 4823 (class 2606 OID 18577)
...
--
-- TOC entry 4824 (class 2606 OID 18582)
...
--
-- TOC entry 4825 (class 2606 OID 18587)
...
--
-- TOC entry 4819 (class 2606 OID 18592)
...
--
-- TOC entry 4826 (class 2606 OID 18597)
-- Name: vendas fk_id_vendedor; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.vendas
    ADD CONSTRAINT fk_id_vendedor FOREIGN KEY (id_vendedor) REFERENCES public.usuario(id) NOT VALID;


--
-- TOC entry 4820 (class 2606 OID 18602)
...
--
-- TOC entry 4817 (class 2606 OID 18607)
...
--
-- TOC entry 4815 (class 2606 OID 18612)
...
-- Completed on 2025-02-26 00:16:44
