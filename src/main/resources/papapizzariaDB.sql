...
-- Started on 2025-02-27 01:35:45
...
--
-- TOC entry 234 (class 1259 OID 20529)
...
--
-- TOC entry 233 (class 1259 OID 20528)
...
--
-- TOC entry 236 (class 1259 OID 20544)
-- Name: usuario_verificador; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.usuario_verificador (
...
ALTER TABLE public.usuario_verificador OWNER TO postgres;

--
-- TOC entry 235 (class 1259 OID 20543)
-- Name: usuario_verificador_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE public.usuario_verificador ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.usuario_verificador_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- TOC entry 4790 (class 2604 OID 18525)
...
--
-- TOC entry 4791 (class 2604 OID 18526)
...
--
-- TOC entry 4792 (class 2604 OID 18527)
...
--
-- TOC entry 4793 (class 2604 OID 18528)
...
--
-- TOC entry 4794 (class 2604 OID 18529)
...
--
-- TOC entry 4797 (class 2604 OID 18530)
...
--
-- TOC entry 4798 (class 2604 OID 18532)
...
--
-- TOC entry 4984 (class 0 OID 18475)
-- Dependencies: 217
...
--
-- TOC entry 4985 (class 0 OID 18480)
-- Dependencies: 218
...
--
-- TOC entry 4987 (class 0 OID 18486)
-- Dependencies: 220
...
--
-- TOC entry 4989 (class 0 OID 18490)
-- Dependencies: 222
...
--
-- TOC entry 4991 (class 0 OID 18496)
-- Dependencies: 224
...
--
-- TOC entry 4992 (class 0 OID 18499)
-- Dependencies: 225
...
--
-- TOC entry 4994 (class 0 OID 18503)
-- Dependencies: 227
...
--
-- TOC entry 4996 (class 0 OID 18511)
-- Dependencies: 229
...
--
-- TOC entry 5001 (class 0 OID 20529)
-- Dependencies: 234
-- Data for Name: usuario; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.usuario (tipo, id, cpfcnpj, email, login, nome_completo, senha, situacao, telefone) FROM stdin;
\.


--
-- TOC entry 5003 (class 0 OID 20544)
-- Dependencies: 236
-- Data for Name: usuario_verificador; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.usuario_verificador (data_expiracao, id, id_usuario, uuid) FROM stdin;
\.


--
-- TOC entry 4998 (class 0 OID 18521)
-- Dependencies: 231
...
-- Dependencies: 235
-- Name: usuario_verificador_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.usuario_verificador_id_seq', 1, false);
...
--
-- TOC entry 4802 (class 2606 OID 18534)
...
--
-- TOC entry 4804 (class 2606 OID 18536)
...
--
-- TOC entry 4806 (class 2606 OID 18538)
...
--
-- TOC entry 4808 (class 2606 OID 18540)
...
--
-- TOC entry 4810 (class 2606 OID 18542)
...
--
-- TOC entry 4812 (class 2606 OID 18544)
...
--
-- TOC entry 4818 (class 2606 OID 20538)
...
--
-- TOC entry 4820 (class 2606 OID 20540)
...
--
-- TOC entry 4822 (class 2606 OID 20542)
...
--
-- TOC entry 4824 (class 2606 OID 20536)
...
--
-- TOC entry 4826 (class 2606 OID 20550)
-- Name: usuario_verificador usuario_verificador_id_usuario_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.usuario_verificador
    ADD CONSTRAINT usuario_verificador_id_usuario_key UNIQUE (id_usuario);


--
-- TOC entry 4828 (class 2606 OID 20548)
-- Name: usuario_verificador usuario_verificador_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.usuario_verificador
    ADD CONSTRAINT usuario_verificador_pkey PRIMARY KEY (id);


--
-- TOC entry 4816 (class 2606 OID 18548)
...
--
-- TOC entry 4800 (class 1259 OID 18549)
...
--
-- TOC entry 4813 (class 1259 OID 18550)
...
--
-- TOC entry 4814 (class 1259 OID 18551)
-- Name: fki_fk_id_vendedor; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- TOC entry 4838 (class 2606 OID 20551)
-- Name: usuario_verificador fk28vf2lusb01547pd4thh5rell; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.usuario_verificador
    ADD CONSTRAINT fk28vf2lusb01547pd4thh5rell FOREIGN KEY (id_usuario) REFERENCES public.usuario(id);


--
-- TOC entry 4831 (class 2606 OID 18552)
...
--
-- TOC entry 4834 (class 2606 OID 18557)
...
--
-- TOC entry 4835 (class 2606 OID 18577)
...
--
-- TOC entry 4836 (class 2606 OID 18582)
...
--
-- TOC entry 4837 (class 2606 OID 18587)
...
--
-- TOC entry 4832 (class 2606 OID 18592)
...
--
-- TOC entry 4833 (class 2606 OID 18602)
...
--
-- TOC entry 4830 (class 2606 OID 18607)
...
--
-- TOC entry 4829 (class 2606 OID 18612)
...
-- Completed on 2025-02-27 01:35:45
